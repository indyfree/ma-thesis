\begin{sidewaystable}[htbp]
    \caption{Sample Raw Car2Go Trip Data in Stuttgart \label{data-car2go-raw}}
    \centering
    ...
    \caption{Sample Processed Car2Go Trip Data in Stuttgart \label{data-car2go-processed}}
    \centering
