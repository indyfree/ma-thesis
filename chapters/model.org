...
originally proposed by textcite:mnih15_human_level_contr_throug_deep_reinf_learn
...
actions).
- Epsilon or Boltzman Policy?
The RL agent was implemented with the neural networks API Keras[fn:1][fn:2],
...
Colaboratory[fn:3] to train and evaluate the
...
2.30GHz (1 core, 2 threads), with 45MB cache, and over 12GB available memory.
 ...
 - Training time/timesteps - Results or here?
