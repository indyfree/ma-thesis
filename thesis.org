...
facilitate smart charging its fleet. Figure ref:fig-control-mechanism depicts
the control mechanism, which is divided into three distinct phases:

# TODO:Other figure, with phase timeline?
The first phase, /Bidding Phase I/, occurs just before the closing time of the
...
EPEX Spot Intraday Continuous). The third phase, /Dispatch Phase/, occurs in
...
# We assume that we can provide the commited energy by different EVs across the
# market period
*** Example
