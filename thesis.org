...
- Light-grey: Determine bidding quantity, Chapter ref:sec-model-rl
  ...
  - RL Agent!
- Middle-grey: Determine bidding price label:sec-model-bidding-strategy

** (Mobility Demand & Clearing Price Prediction)
- Mobility demand prediction made on non-simulated real-world SoC (w/o smart charging)
