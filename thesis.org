...
once, stress the grid. textcite:kim12_carbit find that in these cases, even
...
electricity demand, called /Peak Cutting/ and complement the grid in times of
low demand, called /Valley Filling/. Smart charging has been researched
...
textcite:brandt17_evaluat_busin_model_vehic_grid_integ evaluated a V2G business
...
the conclusion to not include V2G into our simulation.
 ...
 # NOTE: Section Trading strategies, on multiple markets
...
# - And a "normal" charger has 4.6kW to 22kW.
