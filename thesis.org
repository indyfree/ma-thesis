...
same transformer. The RL agents had to take care of charging at minimal costs,
without overloading the transformer. textcite:dusparic13_multi utilized
/W-Learning/ to address learning multiple policies (i.e., objectives like
ensuring minimum battery charged or ensuring charging at low costs) at the same
time. textcite:taylor14_accel_learn_trans_learn extend this research by
...
minimizing charging costs of EVs, which requires neither prior knowledge of
...
# - parencite:vaya14_optim
# - parencite:vaya15_optim_biddin_strat_plug_in
# - parencite:shi11_real
# - parencite:chis16_reinf_learn_based_plug_in
# - parencite:ko18_mobil_aware_vehic_to_grid
