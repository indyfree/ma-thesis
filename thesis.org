...
30 seconds.[fn:regelleistung] Since EV batteries can absorb energy almost
...
negative control reserve.[fn:bundesnetzargentur] The shorter auction cycles
...
# 1. Explain why spot/epex exists
# 2. Explain different types of spot markets
# 3. Focus on intraday continous market
# 4. Explain general characteristics
# 5. Explain auction procedure, with exact times
...
*** Approximation Methods label:sec-fa
...
[fn:1] https://procom-energy.de/
[fn:regelleistung] See https://regelleistung.net/, accessed on 15^{th} February
2019, for further information on the market design and historical data.
[fn:bundesnetzargentur]
