...
the mentioned risks, we introduce a /risk factor/ $\lambda \in \Re_{0 \leq
...
/16.08.2017-15:00/. It predicts that at that point in time, 250 EVs are
...
$\fPhat{h}\!=\!810\kw$, for the same market period /16.08.2017-15:00/, this time
...
*** Dispatch Phase
# When no replacement for VPP is available, we loose rental profits by violating customer mobility
...
#   cite:dauer13_market_based_ev_charg_coord,taylor14_accel_learTrans_learn
