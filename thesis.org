...
pushing for an energy turnaround since 2010  (German: /Energiewende/)[fn:4]. The
...
We obtained real-world trip data from Daimlers carsharing service Car2Go[fn:5]
that operates a large EV fleet in Stuttgart.
- Large cities, electric mobility [fn:6]
- cite:firnkorn15_free_float_elect_carsh_fleet_smart_cities

and electricity market data from the European power exchange EPEX SPOT[fn:7].
Additionally, we collected data from the German electricity market operator
regelleistung.net[fn:8].
...
(https://regelleistung.net). It encompasses weekly lists of anonymized bids
