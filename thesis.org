...
* Model: FleetRL
# NOTE: 20%
# NOTE: Mathematical formulations for Bidding Strategy
# NOTE: Algorithm formulations for Algorithm
# NOTE: Sequence Diagram as Overview
# NOTE: States, Actions, Rewards for RL
# NOTE: Bellman Equatino for RL?
# NOTE: 2-State RL? 1. Only capacity, 2. Also prices?
# NOTE: Formulate Problem of needing to learn capacity allocation
...
interacting with the electricity markets and EV fleet market. The control
mechanism then dispatches and allocates available EVs to their VPPs to provide
the balancing capacity. The chapter is structured as follows: First, the required
...
** Decision Support Overview / Controller
