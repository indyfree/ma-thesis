...
cite:ketter16_multiagent_comp_gaming. It builds on SimPy[fn:2], a process-based
discrete-event simulation framework. FleetSim is available open source[fn:1] and
...
| EV range                                     | 145 km                               |
| Industry electricity price  ($p^{ind}$)      | 0.15[fn:2] $\ekwh$                   |
| EV rental tariff                             | 0.24[fn:3] $\frac{\eur}{\text{min}}$ |
| EV long distance fee ($>\text{200 km}$)      | 0.29[fn:3] $\frac{\eur}{\text{km}}$  |
|----------------------------------------------+--------------------------------------|
...
listed. We can see that the /Integrated (risk-averse)/ strategy performs better
...
#+LATEX: \renewcommand\thempfootnote{\arabic{mpfootnote}}
...
| Gross profit increase (1000 \eur)   |                            43.62 |                           45.08 |                           *67.04* |                            *72.51* |                                  80.02 |
|-------------------------------------+----------------------------------+---------------------------------+-----------------------------------+------------------------------------+----------------------------------------|
|-------------------------------------+----------------------------------+---------------------------------+-----------------------------------+------------------------------------+----------------------------------------|
...
- 2. Graph cumulative (charging) profits over 1 simulation run, w/ learned RL agent (over
  how many iterations?)
...
- What actions? What risk were choosen on average?
...
[fn:1] https://github.com/indyfree/fleetsim

[fn:2] https://pypi.org/project/simpy/

[fn:3] Rental fees according to the Car2Go pricing scheme. See
