...
capacity according to a merit order of the ascending /energy prices/ $p_e$.
...
# NOTE: What about uncertainty? Need to model, otherwise RL makes no sense
...
For the sake of conciseness and brevity, we formulate the problem as a
/controlled EV charging/ problem. The EV fleet operator represents the
...
shorter then market periods. In our case, the market periods of the balancing
market and intraday market are 15 minutes, while we consider EV control periods
of 5 minutes. During the control phase, the controller has to take decisions
about fulfilling its commitments to the markets or compromising customer
mobility.


# Profit maximizing: Charge anyways, but the more it can charge from markets the
# more profit?

# Minimize risk to be beeing able to fulfill commitments
...
decision phases. In the first phase the controller...
...
Other assumptions:
1) Bids on balancing market always get accepted (Known critical capacity price $\overline{p_c}$
...
- What about imbalance costs that can be bough/sold from other market like in
  ...
  a positive imbalance price $\lambda_h^+ < $p_u$. Because positive imbalance
...
- Light-grey: Determine bidding quantity, Chapter ref:sec-model-rl
  ...
  - RL Agent!
- Middle-grey: Determine bidding price ref:sec-model-bidding-strategy
