...
# NOTE: EV battery can provide energy with almost no rampup time/costs -- very
# suitable to provide balancing services.
*** Balancing Market
...
price $p_w$, instead of a market clearing price, this type of auction is a
/pay-as-bid/ auction.
# NOTE: Mention pay as bid
# - We estimate the critical prices, $p_c$ (not) and $p_w$
