...
# data. Individual trips have to be reconstructed using the GPS data of the cars
# and predicting the rental demand is a complex matter. Demand patterns differ
# depending at which place and at what time the EVs are parked.
...
# Stuttgart.
# TODO: How many charging stations in Stuttgart? Whitepaper says 380
