...
textcite:kim12_carbit find that in these cases, even brown- or blackouts are
...
- Peak demand usually occurs then and then
...
# NOTE: Most of it is V2G which is not really relevant for us. Move
# explanation above? Or only explanation and then State why we don't use V2g.
...
- Explain and prove why leaving out V2G.
