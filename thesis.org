...
30 seconds.[fn:1] Since EV batteries can absorb energy almost
...
capacity.
# Fast chargers (22KW) would only need 50EVs, but batteries are depleted much
...
negative control reserve.[fn:2] The shorter auction cycles
...
in this thesis, the EV fleets in our model are only able provide /negative
control reserve/, which we will refer to as /control reserve/ until the end of
...
/working prices/ $p_w$. Hence, providers are also compensated according to the
...
trading volume of approximately 567 TWh in 2018.[fn:3] In Germany, the most
...
day-ahead capacities and the more accurate intraday forecasts on the /intraday
market/. This quantity called /forecast error/ is used by RES generators to
...
- cite:kiesel17_econom_analy_intrad_elect_prices
- cite:karanfil17_role_contin_intrad_elect_market
