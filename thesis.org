...
- Learning from actual experience, Requires no propior knowledge of
...
- On-policy ($\epsilon$-greedy policy) vs off-policy (/target/ (deterministic) and /behaviour/
  policies (stochastic, exploratory), importance sampling)
