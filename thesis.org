...
# Vazquez:
# It is important to note that the RL algorithms to be used should be
# chosen according to the difficulty of the problem being tackled. Not
# every problem requires the use of all these techniques, or of “deep
# learning”, but sometimes simpler algorithms are enough to solve a
# given problem.


# Given is
# adaptability and capacity to learn preferences of the user through in-
# teraction and without an explicit mathematical model, RL is an algo-
# rithm with a great potential of applicability for complex, real-world
# applications, specifically DR.
