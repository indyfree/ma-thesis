...
In this research we will use bidding data from the German secondary reserve market between 06.06.2016 and 01.01.2018. The data contain weekly lists of anonymized bids, where the electricity product, the offered capacity, the capacity price and the energy price of the placed bid is listed. As also negative prices are allowed, the payment direction is included. Moreover we find information whether the bid was fully or partially accepted. That makes it easy to determine the clearing price.
