...
We embed our research in the German markets, where the move to sustainable energies
We obtained real-world trip data from Daimlers flee float carsharing service Car2Go. Additional
- Describe relevance and mechanisms of car-sharing and electricity market auctions

** Electric Vehicle Carsharing Fleets
- EV car fleets
- Environmental Impact: Future of mobility is electric, smart, and eventually autonomous

- Carsharing business model: Flee float
- Car2Go: Stuttgart, 500 EVs
- Stuttgart 220 Charging Stations
- Model individual trips
