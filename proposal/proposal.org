...
|---------------------+----------------------------+--------------------------+---------------+----------------+-----------------|
|---------------------+----------------------------+--------------------------+---------------+----------------+-----------------|
| Product[fn:product] | Capacity Price[fn:euro-mw] | Energy Price[fn:euro-mw] | Payment       | Offered[fn:mw] | Accepted[fn:mw] |
|---------------------+----------------------------+--------------------------+---------------+----------------+-----------------|
...
[fn:euro-mw] Prices are in given in
#+BEGIN_EXPORT latex
\euro{} per megawatt
#+END_EXPORT
[fn:mw] Capacities are given in megawatts
...
|---------------------+---------+------------+----------+------------+-------------+---------------+---------+--------------|
|---------------------+---------+------------+----------+------------+-------------+---------------+---------+--------------|
| Exec time           |      ID | Unit price | Quantity | Buyer area | Seller area | Delivery date | Product | Product time |
|---------------------+---------+------------+----------+------------+-------------+---------------+---------+--------------|
