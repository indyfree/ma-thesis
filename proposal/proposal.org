...
|---------------------+------------------------------+-------------------------------+---------------+-----------------+------------------|
|---------------------+------------------------------+-------------------------------+---------------+-----------------+------------------|
| Product[fn:product] | Capacity Price[fn:cap-price] | Energy Price[fn:energy-price] | Payment       | Offered[fn:cap] | Accepted[fn:cap] |
|---------------------+------------------------------+-------------------------------+---------------+-----------------+------------------|
...
[fn:cap-price] Capacity prices are in given in
#+BEGIN_EXPORT latex
\euro{}/MW.
#+END_EXPORT
[fn:energy-price] Energy prices are in given in
#+BEGIN_EXPORT latex
\euro{}/MWh.
#+END_EXPORT
[fn:cap] Capacities are given in MW.
...
#+END_EXPORT
#+CAPTION: List of Trades of the German Secondary Reserve Market label:spot-market-sample-data
#+ATTR_LATEX: :float sideways :align c|cccccccc :placement [hp]
|---------------------+---------+---------------------------+-----------------------+------------+-------------+---------------+---------+--------------|
|---------------------+---------+---------------------------+-----------------------+------------+-------------+---------------+---------+--------------|
| Exec time           |      ID | Unit price[fn:unit-price] | Quantity[fn:quantity] | Buyer area | Seller area | Delivery date | Product | Product time |
|---------------------+---------+---------------------------+-----------------------+------------+-------------+---------------+---------+--------------|
...
#+END_EXPORT
[fn:unit-price] Unit prices are given in
#+BEGIN_EXPORT latex
\euro{}c/MWh.
#+END_EXPORT
[fn:quantity] Quantities are given in kW.
...
# Cars
** Smart Charging and Discharging Electric Vehicles Fleets, Virtual Power Plants, V2G
...
# Non-Cars
** Using Intelligent Agents for Virtual Power Plants and Electricity Trading
...
cite:zhou15_elect_tradin_negat_prices
