...
** Smart Charging
- Charging EVs at the same time can cause issues in the Grid. Overload transformers and substation parencite:kim12_carbit,sioshansi12_or_forum_model_impac_elect
- Solution in prev. literature: Smart charging: Charge when the list is less congested, reduce peak demands
- EV fleets are given financial incentive, because the price is lower(?) parencite:valogianni14_effec_manag_elect_vehic_storag
- parencite:kara15_estim_benef_elect_vehic_smart Smart scheduling would result in even lower electricity costs for consumers
- Emphasize need for research on charging from the grid.


- parencite:fridgen14

** Vehicle-to-Grid
- Extension of the Smart Charging concept
- Shown succesfully with stationary storage parencite:mashhour11_biddin_strat_virtual_power_plant_2
- parencite:he16_optim_biddin_strat_batter_storag Battery life cycles, important.
- Also included in this study.

- V2G profitable parencite:reichert10_consid_highl_effic_bidir_batter,peterson10_econom_using_plug_in_hybrid, but battery costs crucial

** Dynamic pricing using batteries
- parencite:vytelingum11_theor_pract_found_large_scale show that dynamic pricing for household is profitable
- Dynamic pricing in industries also profitable parencite:zhou15_elect_tradin_negat_prices
-
** General EV profitability when used as Grid Storage
- parencite:schill11_elect_vehic_imper_elect_market find EVS are profitable for consumer electricity prices when used as Storage (V2G)
- parencite:tomic07_using_fleet_elect_drive_vehic_grid_suppor  V2G profitable, especially when high variablity in electricity prices
  - Shorter interval between sale and delivery, the larger the benefits
