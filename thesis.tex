...
\label{sec:orgeb6fe3c}
\subsection{Research Motivation}
\label{sec:org8fb99c0}
...
\clearpage
\section{Background}
\label{sec:org15a4c93}
\subsection{Smart Electricity Markets}
\label{sec:org9f75f96}
...
accessed 19\textsuperscript{th} February, 2019\label{org108e71b}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org108e71b}}. Participants place asks and bids
...
EV long distance fee (\(>\text{200 km}\)) & 0.29\textsuperscript{\ref{orgacc229c}} \(\frac{\eur}{\text{km}}\)\\
\hline
...
\hline
\end{longtable}
\footnotetext[13]{\label{orgd738219}Average prices of electricity for the industry with an annual consumption
of 500 MWh - 2000 MWh in Germany 2017 \cite{bmwi.19_prices_german}.}\footnotetext[14]{\label{orgacc229c}Rental fees according to the Car2Go pricing scheme. See
...
\label{sec:orge456dce}
\begin{itemize}
\item Minimal bidding quantities (100kw, 500kw, 1MW)
\end{itemize}

\section{Conclusion}
\label{sec:orga4ff95c}
\subsection{Contribution}
\label{sec:org02b6b7d}
