...
\label{sec:org3775a99}
\subsection{Research Motivation}
\label{sec:orge40c001}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org11846dc}
\subsection{Relevance}
\label{sec:org61a4f8b}

\section{Background}
\label{sec:orgeefe989}
\subsection{Smart Electricity Markets}
\label{sec:orgc3e5705}
...
accessed 19\textsuperscript{th} February, 2019\label{org8f37528}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org8f37528}}. Participants place asks and bids
...
\label{sec:org0ea0aee}
\subsubsection{Example}
\label{sec:orgc6d12ff}
...
\clearpage
\section{Results}
\label{sec:org4876053}
\subsection{Simulation Settings}
\label{sec:org374cb4a}
\begin{itemize}
