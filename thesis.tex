...
\subsubsection{Further Advancements}
\label{sec:orgbf69854}
\begin{itemize}
\item Eligibility traces
\item W-Learning
\item Fitted Q-Iteration
\item Actor-Critic
\item Distributed Actor-Critic Diff-DAC?
\end{itemize}

\section{Empirical Setting / Data (10\%)}
\label{sec:orgfa5e73b}
\subsection{Carsharing Fleets of Electric Vehicles}
\label{sec:orgc33c442}
