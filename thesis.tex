...
\label{sec:org4a36809}
\subsection{Research Motivation}
\label{sec:org6d2e078}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org2b3de09}
\subsection{Relevance}
\label{sec:orgfd45c19}

\section{Background}
\label{sec:org8d74faf}
\subsection{Smart Electricity Markets}
\label{sec:orgdac90f6}
...
accessed 19\textsuperscript{th} February, 2019\label{org782146f}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org782146f}}. Participants place asks and bids
...
fleet, while the critical capacity price \(\ccp{}\!\in\! \Re^+_0\) is always
greater than zero and therefore never results in costs for the fleet. The cost
...
\label{sec:org52adb10}
\subsubsection{Dispatch Phase: Real-time}
\label{sec:org8a45180}
...
\clearpage
\section{Results}
\label{sec:orgf0ccdce}
\subsection{FleetRL}
\label{sec:orgdb308d4}
\subsection{Sensitivity Analysis: Prediction Accuracy}
\label{sec:orgef73cfd}
\subsection{Sensitivity Analysis: Infrastructure Changes}
\label{sec:org4c90491}
\subsection{Sensitivity Analysis: Bidding Strategy}
\label{sec:orgd4b55cc}
\section{Conclusion}
\label{sec:orgc7bb259}
\subsection{Contribution}
\label{sec:org771f53a}

\subsection{Limitations}
\label{sec:org89be339}
\subsection{Future Research}
\label{sec:orgff60085}
