...
\label{sec:org1716292}
\subsection{Electricity Markets}
\label{sec:orgde1f75f}
\subsubsection{Balancing Market}
\label{sec:org5d9bef3}
\subsubsection{Spot Market}
\label{sec:orge26b288}
\subsection{Reinforcement Learning \label{sec-reinforcement-learning}}
\label{sec:orgfebcfc0}
The following chapter will give an overview about the most important
Reinforcement Learning (RL) concepts and will introduce the corresponding
mathematical formulations. If not noted otherwise, the notation, equations and
insights are adapted from \cite{sutton18_reinf}, the de-facto reference book of RL
research.
...
with its environment. The agents objective is to maximize rewards it receives
...
Chapter \ref{sec-mdp}. The most important task of RL agents is to continuously
...
state transitions are unknown and the agents behavior has to be learned from
...
\subsubsection{Approximation Methodsl:sec-approx  \label{sec-fa}}
\label{sec:orgd3ef0a4}
...
\label{sec:orge61dc43}
\subsection{Carsharing Fleets of Electric Vehicles}
\label{sec:org7ed43ee}
\subsubsection{Raw Data}
\label{sec:org3a05bf7}
