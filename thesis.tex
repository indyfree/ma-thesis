...
\clearpage
\section{Background}
\label{sec:org11bc83d}
\subsection{Smart Electricity Markets}
\label{sec:org3dfc390}
...
they could theoretically handle the minimum capacity requirements if they are
large enough. Around 220 EVs would need to simultaneously charge at standard
4.6kW charging stations to provide 1MW of downward regulating capacity.
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org5b7997e}}. Participants place asks and bids
...
adopted from \textcite{sutton18_reinf}, the de-facto reference book of RL
research.
...
EV long distance fee (\(>\text{200 km}\)) & 0.29\textsuperscript{\ref{org59fc30c}} \(\frac{\eur}{\text{km}}\)\\
\hline
...
\hline
\end{tabular}
\end{table}\footnotetext[12]{\label{org56b4e60}Average prices of electricity for the industry with an annual consumption
of 500 MWh - 2000 MWh in Germany 2017 \cite{bmwi.19_prices_german}.}\footnotetext[13]{\label{org59fc30c}Rental fees according to the Car2Go pricing scheme. See
...
fleet charging schedules, \textcite{vandael15_reinf_learn_heuris_ev_fleet}
...
\textcite{chis16_reinf_learn_based_plug_in} investigated a RL approach to reduce
...
\textcite{pandzic13_offer_model_virtual_power_plant}. We also like to emphasize
