...
\label{sec:org30ed613}
\subsection{Research Motivation}
\label{sec:org44aa017}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org09c70c4}
\subsection{Relevance}
\label{sec:org1ab3a01}

\section{Background}
\label{sec:orgbba6b5e}
\subsection{Smart Electricity Markets}
\label{sec:org697e757}
...
accessed 19\textsuperscript{th} February, 2019\label{orgd9a7649}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orgd9a7649}}. Participants place asks and bids
...
\(\ec\) & Opportunity costs of lost rental of EV \(i\) in control period \(t\). & \(\eur\)\\
...
\label{sec:org39379d5}
\subsubsection{Example}
\label{sec:org1741a71}
...
\clearpage
\section{Results}
\label{sec:org7710cb4}
\subsection{Simulation Settings}
\label{sec:org54a6129}
\begin{itemize}
