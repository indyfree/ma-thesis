...
\label{sec:orgf56722d}
\subsection{Research Motivation}
\label{sec:orgcb410e4}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org01baff9}
\subsection{Relevance}
\label{sec:org043fd57}

\section{Theoretical Background}
\label{sec:org79683b0}
\subsection{Electricity Markets}
\label{sec:org632f0f4}
...
accessed 19\textsuperscript{th} February, 2019\label{orgb0ab5ec}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orgb0ab5ec}}. Participants place asks and bids
