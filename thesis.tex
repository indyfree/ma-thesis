...
\label{sec:org4c2f020}
\subsection{Research Motivation}
\label{sec:org6a7469b}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org3e45381}
\subsection{Relevance}
\label{sec:org9340162}

\section{Theoretical Background}
\label{sec:org6ab434c}
\subsection{Electricity Markets}
\label{sec:org02a3cf6}
...
accessed 19\textsuperscript{th} February, 2019\label{org25c90f0}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org25c90f0}}. Participants place asks and bids
...
charging. Online EV \emph{control periods} \(t\) are typically shorter than market
periods. In our case, the market periods of the considered markets are 15
minutes long, while we consider EV control periods of 5 minutes.
During each control period the controller takes decisions about dispatching
individual EVs for charging according to a heuristic function \(f_{heur}\).


In times of unforeseen rental demand, the
controller has to take decisions about fulfilling its commitments to the markets
or compromising customer mobility by denying rentals in each control period.
...
\hline
\(f^{heur}\) & Heuristic function to dispatch EVs to charging & -\\
\hline
\hline
\end{longtable}

\subsection{Required Information Assumptions}
\label{sec:orga629c77}
...
\item Use Notation of consumption plan?
...
\end{itemize}
\subsection{FleetRL}
\label{sec:org4668062}
\subsection{Sensitivity Analysis: Prediction Accuracy}
\label{sec:org778084f}
\subsection{Sensitivity Analysis: Infrastructure Changes}
\label{sec:orgb30d3d2}
\subsection{Sensitivity Analysis: Bidding Strategy}
\label{sec:org3735298}
\section{Discussion}
\label{sec:orgd2dcaa1}
\subsection{Generalizability}
\label{sec:orgaac70e0}
\subsection{Future Electricity Landscape}
\label{sec:orgcab0dd4}
\subsection{Limitations}
\label{sec:org9157345}
\section{Conclusion}
\label{sec:org3967968}
\subsection{Contribution}
\label{sec:org01308f0}
\subsection{Future Research}
\label{sec:org958231f}
