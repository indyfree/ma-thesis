...
\label{sec:orgc52e0e8}
\subsection{Research Motivation}
\label{sec:orgb30c6be}
...
\clearpage
\section{Background}
\label{sec:org2a0dc55}
\subsection{Smart Electricity Markets}
\label{sec:org2f13a51}
...
accessed 19\textsuperscript{th} February, 2019\label{org981c921}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org981c921}}. Participants place asks and bids
...
EV long distance fee (\(>\text{200 km}\)) & 0.29\textsuperscript{\ref{org80c4f06}} \(\frac{\eur}{\text{km}}\)\\
\hline
...
\hline
\end{tabular}
\end{table}\footnotetext[12]{\label{org88a3c07}Average prices of electricity for the industry with an annual consumption
of 500 MWh - 2000 MWh in Germany 2017 \cite{bmwi.19_prices_german}.}\footnotetext[13]{\label{org80c4f06}Rental fees according to the Car2Go pricing scheme. See
