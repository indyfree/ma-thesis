...
\label{sec:orgcb37df2}
\subsection{Research Motivation}
\label{sec:orgd679e38}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org8293373}
\subsection{Relevance}
\label{sec:org8ccc5fd}

\section{Background}
\label{sec:org9ae82a7}
\subsection{Smart Electricity Markets}
\label{sec:orga91b22f}
...
accessed 19\textsuperscript{th} February, 2019\label{org70d6dec}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org70d6dec}}. Participants place asks and bids
...
\emph{model-free} approach (see Chapter \ref{sec-td-learning}).
...
The RL agent was written in Python 3.6, and used the library Keras
(\url{https://keras.io/}). Keras is "a high-level neural networks API, [\ldots{}] capable
of running on top of TensorFlow [\ldots{}] with a focus on enabling fast
experimentation".
...
\end{itemize}
\section{Results}
\label{sec:org6d13420}
\subsection{Simulation Settings}
\label{sec:orgd6be06b}
\begin{itemize}
...
\end{itemize}
\section{Conclusion}
\label{sec:orgacffc94}
\subsection{Contribution}
\label{sec:org0605e52}
\begin{itemize}
