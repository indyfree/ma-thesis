...
\label{sec:orgdc0c58a}
\subsection{Research Motivation}
\label{sec:org8896512}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:orgd9683c3}
\subsection{Relevance}
\label{sec:orge0a3a93}

\section{Background}
\label{sec:org58f9dd8}
\subsection{Smart Electricity Markets}
\label{sec:org6e83443}
...
accessed 19\textsuperscript{th} February, 2019\label{org80d7da8}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org80d7da8}}. Participants place asks and bids
