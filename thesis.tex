...
\label{sec:org495df91}
\subsection{Research Motivation}
\label{sec:org5dc04d7}
...
\clearpage
\section{Background}
\label{sec:org3eae6f9}
\subsection{Smart Electricity Markets}
\label{sec:org114e43b}
...
accessed 19\textsuperscript{th} February, 2019\label{orgd295c24}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orgd295c24}}. Participants place asks and bids
...
\hline
\end{longtable}
\footnotetext[13]{\label{orgfa595db}Rental fees according to the Car2Go pricing scheme. See
...
\begin{itemize}
\item \cite{chis16_reinf_learn_based_plug_in}
\end{itemize}
...
\begin{itemize}
\item What actions? What risk were choosen on average?
\end{itemize}


\subsection{Sensitivity Analysis}
\label{sec:org1c85f6b}
\subsubsection{Prediction Accuracy}
\label{sec:org5a40970}
\begin{itemize}
\item Compare profits of (50\%, 60\%, 70\%, 80\%, 90\%, 100\%)
\end{itemize}

\subsubsection{Charging infrastructure}
\label{sec:orgf22326f}
\begin{itemize}
...
\label{sec:org5e874f7}
\begin{itemize}
\item Minimal bidding quantities (100kw, 500kw, 1MW)
\end{itemize}

\section{Conclusion}
\label{sec:org7eaff34}
\subsection{Contribution}
\label{sec:orgef3d0c7}
\begin{itemize}
