...
\label{sec:org7d03d03}
\subsection{Research Motivation}
\label{sec:org709afec}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:orgb299c32}
\subsection{Relevance}
\label{sec:org00e9e66}
...
\label{sec:orgdf0fb74}
\subsection{Electricity Markets}
\label{sec:orgd0b9664}
\subsubsection{Balancing Market}
\label{sec:orgff0370f}
\subsubsection{Spot Market}
\label{sec:org40a0db6}
\subsection{Reinforcement Learning}
\label{sec:orgad00e74}
\subsubsection{Notation}
\label{sec:orge3d5ea7}
