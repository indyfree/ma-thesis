...
\label{sec:orge4cc026}
\subsection{Research Motivation}
\label{sec:org5c51e1f}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:orgc9428e2}
\subsection{Relevance}
\label{sec:org1edae74}

\section{Theoretical Background}
\label{sec:org3ef4447}
\subsection{Electricity Markets}
\label{sec:orgd2a1ef9}
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orgff464d9}}. Participants place asks and bids
...
orders exist at the time of interest. The intraday market volume of 82TWh is
considerably smaller than day-ahead market's volume. Despite that, the intraday
market plays a vital role to the stability of the grid. All executed trades on
the intraday market potentially reduce the activation of control reserve through
the TSO.
...
\label{sec:org57d3f9b}
\begin{enumerate}
\item The controller can estimate the mobility demand of its EV fleet based on
...
\item The controller can estimate the loads and prices of spot and balancing
markets based on historical data.
\begin{itemize}
\item \cite{weron14_elect_price_forec}
\item \cite{avci18_manag_elect_price_model_risk}
\item \cite{brandt17_evaluat_busin_model_vehic_grid_integ,vandael15_reinf_learn_heuris_ev_fleet}?
\item \cite{mashhour11_biddin_strat_virtual_power_plant_1}
\item Review: See proposal
\end{itemize}
\end{enumerate}
...
\item Battery depreciation not considered
\end{enumerate}
\subsection{Control Mechanism}
\label{sec:orgd9da7d7}
2 Phases:
\begin{enumerate}
\item Decision Phase I: Day-ahead/Week-ahead
\item Decision Phase II: Intraday
\item Real-time / Allocation phase?
\end{enumerate}
...
\label{sec:org3a8c807}
\subsection{Event-based Simulation}
\label{sec:org3726a1d}
\subsection{Architecture / Components}
\label{sec:org24bc38e}
\subsection{Modular Expandability}
\label{sec:orgd21afdd}

\section{Evaluation / Results}
\label{sec:org414a1c6}
