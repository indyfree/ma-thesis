...
\label{sec:orgc48b6d3}
\subsection{Electricity Markets}
\label{sec:orgaadf3ad}
\subsubsection{Balancing Market}
\label{sec:orgf687e43}
\subsubsection{Spot Market}
\label{sec:org43dccc1}
\subsection{Reinforcement Learning \label{reinforcement-learning}}
\label{sec:orgc4ea47e}
...
\label{sec:org9e3e65d}
\paragraph{Policy}
\label{sec:org1f64f79}
\begin{itemize}
...
\begin{itemize}
\item Learning from actual experience, Requires no propior knowledge of
...
\item On-policy (\$\e\$-greedy) vs off-policy (control and exploration policies)
\end{itemize}
