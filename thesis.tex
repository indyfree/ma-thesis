...
modeled as a discrete-time MDP and solved through \emph{Q-Learning}. The algorithm
controls the V2G actions of the EV and can react to real-time price signals of
the market. It is a single-agent approaches where the action space only
compromises the control actions charging, discharging and regulation.
\textcite{chis16_reinf_learn_based_plug_in} looked at reducing costs of charging
for single EVs using known day-ahead prices and predicted next-day prices.
For prediction a Bayesian ANN was employed and \emph{fitted Q-Learning} was used
learn daily battery levels to be charged. In their research, the authors used
...
\label{sec:org802b83c}
\subsection{Electricity Markets}
\label{sec:org7f0db7b}
\subsubsection{Balancing Market}
\label{sec:orgc9c6c9e}
\subsubsection{Spot Market}
\label{sec:org21c6376}
\subsection{Reinforcement Learning \label{reinforcement-learning}}
\label{sec:orgd6b9d6e}
\subsubsection{Notation}
\label{sec:orged76b96}
...
\label{sec:orge7f5e05}
\subsubsection{Q-Learning}
\label{sec:org9489dde}
\subsubsection{Function Approximation}
\label{sec:org9b677b5}
\subsubsection{Exploitation-Exploration Tradeoff}
\label{sec:orgf64a41b}
\subsubsection{Deep Reinforcement Learning}
\label{sec:org24354b6}
\section{Empirical Setting / Data (10\%)}
\label{sec:org4668d11}
\subsection{Carsharing Fleets of Electric Vehicles}
\label{sec:org7d498ba}
\subsubsection{Raw Data}
\label{sec:orga76be11}
