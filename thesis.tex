...
accessed 19\textsuperscript{th} February, 2019\label{org43881e3}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org43881e3}}. Participants place asks and bids
...
\label{sec:org51c5e1c}
The first decision phase occurs just before the closing time of the balancing
market, once every week (Wednesdays at 3pm at the GCRM). In this phase, the
...
price \(\cep{}\!\in\!\Re\), can take negative values, resulting in profits for the
fleet, while the critical capacity price \(\ccp{}\!\in\! \Re^+_0\) is always
greater than zero and thus never results in costs for the fleet. The cost
...
negative or positive, resulting in costs or profits for the fleet.
...
Decision Phase I and continues to Decision Phase II.

Based on the expected available charging capacity one week ahead \(\fPhat{h + (H
\times 7)}\), the controller now needs to take a decision the amount of
electricity it should submit to the intraday market. Determining the bidding
quantity is a core piece of the control mechanism. The controller needs to
balance the risks of a) Not committing enough and thus charging its fleet enough
(really?) b) Committing more than it can deliver and thus either facing
...
\label{sec:org9f7ee97}
\subsubsection{Dispatch Phase: Real-time}
\label{sec:orgb27c5b9}
...
\end{itemize}
\subsection{FleetRL}
\label{sec:orga93e9d7}
\subsection{Sensitivity Analysis: Prediction Accuracy}
\label{sec:org078351e}
\subsection{Sensitivity Analysis: Infrastructure Changes}
\label{sec:orgfc94234}
\subsection{Sensitivity Analysis: Bidding Strategy}
\label{sec:org22616e7}
\section{Discussion}
\label{sec:org29e33c6}
\subsection{Generalizability}
\label{sec:org10f8d0a}
\subsection{Future Electricity Landscape}
\label{sec:orgdfda606}
\subsection{Limitations}
\label{sec:org2a3f248}
\section{Conclusion}
\label{sec:org11adb5f}
\subsection{Contribution}
\label{sec:org0a7f990}
\subsection{Future Research}
\label{sec:orgeb032d7}
