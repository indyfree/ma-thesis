...
\label{sec:orgc534cf7}
\subsection{Research Motivation}
\label{sec:org2570274}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:orgf0f5124}
\subsection{Relevance}
\label{sec:orgc1bcbf2}

\section{Theoretical Background}
\label{sec:org277c62f}
\subsection{Electricity Markets}
\label{sec:org4b1b21e}
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orgedd4d8a}}. Participants place asks and bids
