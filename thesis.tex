...
\label{sec:orgbdcc773}
\subsection{Research Motivation}
\label{sec:org7a9c857}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org03904d3}
\subsection{Relevance}
\label{sec:org32a5770}

\section{Background}
\label{sec:orgdc26dee}
\subsection{Smart Electricity Markets}
\label{sec:orgb0b08a0}
...
accessed 19\textsuperscript{th} February, 2019\label{org192864b}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org192864b}}. Participants place asks and bids
...
power (\(\fPhat{h}\!=\!900\kw\)), given the charging power of 3.6kW per EV.
Assuming the available critical prices \(\ccp{h}\!=\!5\emw\),
\(\cep{h}\!=\!-10\emwh\), and \(\cup{h}\!=\!10\emwh\) for that market period, the
controller now evaluates the cheapest charging option. The flat industry
electricity tariff is assumed to be \(p_i\!=\!0.15\ekwh\). The costs for charging
with the maximal amount of power \(\fPhat{h}\) from the balancing market
\(\Cb{h}(900)\!=\!-6.25\eur\) are less than charging from the intraday market
\(\Ci{h}(900)\!=\!2.25\eur\) or charging at the industry tariff
...
\clearpage
\section{Results}
\label{sec:orgd00a285}
\subsection{Simulation Settings}
\label{sec:org119d7b7}
\begin{itemize}
