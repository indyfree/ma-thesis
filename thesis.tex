...
\label{sec:org0998290}
\subsection{Research Motivation}
\label{sec:org90c0fa1}
...
\clearpage
\section{Background}
\label{sec:orgdc6943c}
\subsection{Smart Electricity Markets}
\label{sec:org72c8bb3}
...
accessed 19\textsuperscript{th} February, 2019\label{org833db04}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org833db04}}. Participants place asks and bids
...
\cite{ketter16_multiagent_comp_gaming}. It builds on SimPy\footnote{\url\{\url{https://pypi.org/project/simpy/}}, a process-based
...
EV long distance fee (\(>\text{200 km}\)) & 0.29\textsuperscript{\ref{orgdfeed26}} \(\frac{\eur}{\text{km}}\)\\
\hline
...
\hline
\end{longtable}
\footnotetext[13]{\label{org618d35c}Average prices of electricity for the industry with an annual consumption
of 500 MWh - 2000 MWh in Germany 2017 \cite{bmwi.19_prices_german}.}\footnotetext[14]{\label{orgdfeed26}Rental fees according to the Car2Go pricing scheme. See
...
\label{sec:orgaf26a55}
\begin{itemize}
\item Compare to most similar studies:
\end{itemize}
