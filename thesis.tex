...
\label{sec:orga26356e}
\subsection{Research Motivation}
\label{sec:org65f03a9}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org56c531e}
\subsection{Relevance}
\label{sec:org38d0979}

\section{Background}
\label{sec:org9ba7f57}
\subsection{Smart Electricity Markets}
\label{sec:orgf75af06}
...
accessed 19\textsuperscript{th} February, 2019\label{orgda06830}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orgda06830}}. Participants place asks and bids
...
\begin{split}
    ...
    &= -(P  \times \ccp{h}) + (P \frac{\Delta h}{60}10^{-3} \times \cep{h}) \text{ ,}
\end{split}
\end{equation}
...
account for the mentioned risks, we introduce a \emph{risk factor} \(\lambda \in
...
\begin{equation}
  ...
  \end{cases}
\end{equation}
Any amount of electricity that the controller procured from the
balancing market, does not need to bought from intraday market. Note that
the predicted charging power \(\fPhat{h}\) is expected to be  more accurate at
this point in time.

\begin{itemize}
\item Prediction might be different
\item Risk factor lower, since more accurate predictions
\end{itemize}
...
\emph{Example:} Given, \(\Cb{h}\), \(\Ci{h}\), p\textsuperscript{i}
...
\clearpage
\section{Results}
\label{sec:org7e2d235}
\subsection{FleetRL}
\label{sec:org782d92b}
\subsection{Sensitivity Analysis: Prediction Accuracy}
\label{sec:orgda181d5}
\subsection{Sensitivity Analysis: Infrastructure Changes}
\label{sec:org73eb4d4}
\subsection{Sensitivity Analysis: Bidding Strategy}
\label{sec:orgfec84b1}
\section{Conclusion}
\label{sec:org4e38b32}
\subsection{Contribution}
\label{sec:org2eb87ff}

\subsection{Limitations}
\label{sec:orge5bffcd}
\subsection{Future Research}
\label{sec:orgb228d05}
