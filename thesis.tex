...
\label{sec:org1821507}
\subsection{Research Motivation}
\label{sec:orgac8ec5b}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:orgfbd75f1}
\subsection{Relevance}
\label{sec:orgcde58d8}

\section{Background}
\label{sec:orgb21dbed}
\subsection{Smart Electricity Markets}
\label{sec:org6ad1f69}
...
accessed 19\textsuperscript{th} February, 2019\label{orge4bae83}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orge4bae83}}. Participants place asks and bids
...
detail in Chapter \ref{sec-model-rl}.

\subsubsection{Dispatch Phase}
\label{sec:org8933d08}
\begin{itemize}
\item \(f_{heur}\) Heuristic function to dispatch power to EVs
\item NOTE: Similar to \cite{vandael15_reinf_learn_heuris_ev_fleet}
\end{itemize}


\subsubsection{Example}
\label{sec:org25f6749}
At 3pm on the 9\textsuperscript{th} of August 2017, the controller enters its first decision
...
determine the bidding quantity.

Therefore, it employs a RL agent, which determines the risk of bidding on the
balancing market at \(\lb{h}\!=\!0.3\). Consequently, the controller sets the
bidding quantity to
...
its second decision phase. It predicts the available fleet charging power
\(\fPhat{h}\!=\!810\kw\), for the same market period \emph{16.08.2017-15:00}, this time
with a very high accuracy, due to the short time horizon of 30 minutes. By
...
\clearpage
\section{Results}
\label{sec:orgbd2a35d}
\subsection{Simulation Settings}
\label{sec:org5be39db}
\begin{itemize}
