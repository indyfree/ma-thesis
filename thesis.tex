...
\label{sec:orgacb6d80}
\subsection{Research Motivation}
\label{sec:org3741b46}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org5d69e28}
\subsection{Relevance}
\label{sec:org0e81407}

\section{Theoretical Background}
\label{sec:org3a6ef36}
\subsection{Electricity Markets}
\label{sec:orgfeb46fc}
...
accessed 19\textsuperscript{th} February, 2019\label{orga07cd74}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orga07cd74}}. Participants place asks and bids
...
power in the control periods that make up the market period (N\textsubscript{t}).
\begin{equation}
...
In a second step the controller predicts the clearing prices for both markets.
...
\end{itemize}
\subsection{FleetRL}
\label{sec:org837106f}
\subsection{Sensitivity Analysis: Prediction Accuracy}
\label{sec:org8f93550}
\subsection{Sensitivity Analysis: Infrastructure Changes}
\label{sec:org44fe65d}
\subsection{Sensitivity Analysis: Bidding Strategy}
\label{sec:orgbfeee98}
\section{Discussion}
\label{sec:orgc04076e}
\subsection{Generalizability}
\label{sec:orgae47016}
\subsection{Future Electricity Landscape}
\label{sec:orgfaef868}
\subsection{Limitations}
\label{sec:org7439988}
\section{Conclusion}
\label{sec:orgef9801c}
\subsection{Contribution}
\label{sec:org7c8ea8d}
\subsection{Future Research}
\label{sec:orgd2d3400}
