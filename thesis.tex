...
\label{sec:org792ae86}
\subsection{Research Motivation}
\label{sec:org8dbfc87}
...
\clearpage
\section{Background}
\label{sec:org948e488}
\subsection{Smart Electricity Markets}
\label{sec:orgb8091cc}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{fig/electricity-markets.png}
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org224aae7}}. Participants place asks and bids
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{fig/mdp-interaction.png}
...
EV long distance fee (\(>\text{200 km}\)) & 0.29\textsuperscript{\ref{org74f1bcb}} \(\frac{\eur}{\text{km}}\)\\
\hline
...
\hline
\end{tabular}
\end{table}\footnotetext[12]{\label{org33dd295}Average prices of electricity for the industry with an annual consumption
of 500 MWh - 2000 MWh in Germany 2017 \cite{bmwi.19_prices_german}.}\footnotetext[13]{\label{org74f1bcb}Rental fees according to the Car2Go pricing scheme. See
