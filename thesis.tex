...
\label{sec:orgb5d437d}
\subsection{Research Motivation}
\label{sec:org10c2dde}
...
\clearpage
\section{Background}
\label{sec:org6d2eefd}
\subsection{Smart Electricity Markets}
\label{sec:org7d473dd}
...
accessed 19\textsuperscript{th} February, 2019\label{orge2d26b6}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{orge2d26b6}}. Participants place asks and bids
...
EV long distance fee (\(>\text{200 km}\)) & 0.29\textsuperscript{\ref{org0328076}} \(\frac{\eur}{\text{km}}\)\\
\hline
...
\hline
\end{tabular}
\end{table}\footnotetext[12]{\label{org920a439}Average prices of electricity for the industry with an annual consumption
of 500 MWh - 2000 MWh in Germany 2017 \cite{bmwi.19_prices_german}.}\footnotetext[13]{\label{org0328076}Rental fees according to the Car2Go pricing scheme. See
