...
\label{sec:org0f48132}
\subsection{Research Motivation}
\label{sec:org4053eda}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org753b1a2}
\subsection{Relevance}
\label{sec:org91500a7}

\section{Theoretical Background}
\label{sec:org8f9e98a}
\subsection{Electricity Markets}
\label{sec:org6725869}
...
accessed 19\textsuperscript{th} February, 2019\label{org0d45bc9}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org0d45bc9}}. Participants place asks and bids
...
pushing for an energy turnaround since 2010  (German: \emph{Energiewende})\footnote{Energy Concept for an Environmentally Sound, Reliable and Affordable energy \cite{economics10_energ_concep_envir_sound_reliab_affor}}. The
...
We obtained real-world trip data from Daimlers carsharing service Car2Go\footnote{\url{https://www.car2go.com}}
that operates a large EV fleet in Stuttgart.
\begin{itemize}
\item Large cities, electric mobility \footnote{\url{https://www.car2go.com/media/data/germany/microsite-press/files/car2go\_white-paper\_electric-mobility\_2018.pdf},
accessed 21\textsuperscript{th} February 2019.}
\item \cite{firnkorn15_free_float_elect_carsh_fleet_smart_cities}
\end{itemize}

and electricity market data from the European power exchange EPEX SPOT\footnote{\url{https://www.epexspot.com}}.
Additionally, we collected data from the German electricity market operator
regelleistung.net\footnote{\url{https://www.regelleistungen.net}}.


\subsection{Electronic Vehicle Fleet Data}
\label{sec:org75afe53}

\subsection{Balancing Market Data}
\label{sec:orga414e44}
...
The data can be freely obtained at the GCRM platform website
(\url{https://regelleistung.net}). It encompasses weekly lists of anonymized bids
between 01.06.2016 and 01.01.2018. The electricity product, the offered capacity
\(P\) (MW), the capacity price \(p_c\) (\(\text{\euro{}/MW}\)) and the energy price
\(p_e\) (\(\text{\euro{}/MWh}\)) of each bid is listed. Four different products are
