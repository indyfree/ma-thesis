...
\label{sec:org18fce17}
\subsection{Electricity Markets}
\label{sec:orga4b99a0}
\subsubsection{Balancing Market}
\label{sec:orgc6111f5}
\subsubsection{Spot Market}
\label{sec:org6933961}
\subsection{Reinforcement Learning \label{reinforcement-learning}}
\label{sec:orgcfd1100}
\subsubsection{Notation}
\label{sec:orge334ea1}
...
\label{sec:org66acc91}
\subsubsection{Q-Learning}
\label{sec:orgead1f7e}
\subsubsection{Function Approximation}
\label{sec:org3207aa1}
\subsubsection{Exploitation-Exploration Tradeoff}
\label{sec:orgcfc68c1}
\subsubsection{Deep Reinforcement Learning}
\label{sec:orgced58d6}
\section{Empirical Setting / Data (10\%)}
\label{sec:orgaf43ebb}
\subsection{Carsharing Fleets of Electric Vehicles}
\label{sec:org632ea0d}
\subsubsection{Raw Data}
\label{sec:org524714f}
