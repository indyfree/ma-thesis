...
\label{sec:org9779deb}
\subsection{Electricity Markets}
\label{sec:org82153f7}
\subsubsection{Balancing Market}
\label{sec:org153cfa1}
\subsubsection{Spot Market}
\label{sec:org9be4717}
\subsection{Reinforcement Learning \label{reinforcement-learning}}
\label{sec:orgea0290c}
...
\label{sec:org14208c7}
\paragraph{Policy}
\label{sec:orgd34cd26}
\begin{itemize}
...
actual experienced transitions in place of knowledge of the expected
transitions. We will explore some of these methods in the following Chapters
\end{quote}

\subsubsection{Tabular Methods}
\label{sec:orge434615}
