...
\label{sec:org1485f49}
\subsection{Research Motivation}
\label{sec:org53f6fb5}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org25d5277}
\subsection{Relevance}
\label{sec:org97cf2af}

\section{Theoretical Background}
\label{sec:orgf871103}
\subsection{Electricity Markets}
\label{sec:org4091bc9}
...
accessed 19\textsuperscript{th} February, 2019\label{org50f8d5b}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org50f8d5b}}. Participants place asks and bids
