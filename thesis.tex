...
\label{sec:orgc380ae7}
\subsection{Research Motivation}
\label{sec:org6d4b3bd}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org5f494c5}
\subsection{Relevance}
\label{sec:orgae71bb1}

\section{Background}
\label{sec:org08994be}
\subsection{Smart Electricity Markets}
\label{sec:org989217a}
...
accessed 19\textsuperscript{th} February, 2019\label{org28676e5}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org28676e5}}. Participants place asks and bids
...
\begin{split}
    \Cb{h}(P) &\defeq  -(P\!\times\!\frac{1}{10^{3}} \times \ccp{h}) + (\Eb{h} \times \cep{h}) \\
...
can not take negative values and therefore never results in costs for the fleet.
...
applied to previously unknown settings and learn from uncertain environments,
like mobility and electricity markets, we chose to solve the problem with a RL
learning approach that is explained in detail in Chapter \ref{sec-model-rl}.

\subsubsection{Dispatch Phase}
\label{sec:orgef6b3d5}
\subsubsection{Example}
\label{sec:orgbe062de}
...
\label{sec:org0aa6835}


\section{Simulation Platform: FleetSim}
\label{sec:orgc1ec3e3}
\begin{itemize}
...
\clearpage
\section{Results}
\label{sec:org662b019}
\subsection{Simulation Settings}
\label{sec:orgf1d4265}
\begin{itemize}
