...
\label{sec:org2be7c89}
\subsection{Electricity Markets}
\label{sec:org256fba7}
\subsubsection{Balancing Market}
\label{sec:org5d57e5f}
\subsubsection{Spot Market}
\label{sec:orgd6a294b}
\subsection{Reinforcement Learning \label{reinforcement-learning}}
\label{sec:org9f2c3a4}
...
\label{sec:org60bf6b8}
\paragraph{Policy}
\label{sec:orgfda5b5a}
\begin{itemize}
...
used in RL and has been formulated as the \emph{Bellman equation}. The Bellman
