...
\label{sec:orge015316}
\subsection{Research Motivation}
\label{sec:org8825891}
\begin{itemize}
\item \cite{lopes11_integ_elect_vehic_elect_power_system}
\end{itemize}
\subsection{Research Question}
\label{sec:org1dece2b}
\subsection{Relevance}
\label{sec:orgee2bceb}

\section{Theoretical Background}
\label{sec:orge3004d9}
\subsection{Electricity Markets}
\label{sec:org78fb346}
...
accessed 19\textsuperscript{th} February, 2019\label{org8a3a337}}, but most electronic
...
trading volume of over 234TWh in 2018\textsuperscript{\ref{org8a3a337}}. Participants place asks and bids
...
markets with compromising customer mobility by denying rentals.
...
\end{itemize}
\subsection{FleetRL}
\label{sec:orge1e1425}
\subsection{Sensitivity Analysis: Prediction Accuracy}
\label{sec:orgf9b1f06}
\subsection{Sensitivity Analysis: Infrastructure Changes}
\label{sec:orgf9bc3f5}
\subsection{Sensitivity Analysis: Bidding Strategy}
\label{sec:org1b73ed0}
\section{Discussion}
\label{sec:orgb5d7ee6}
\subsection{Generalizability}
\label{sec:org0efa12b}
\subsection{Future Electricity Landscape}
\label{sec:orgf2cd030}
\subsection{Limitations}
\label{sec:orgaa38ec6}
\section{Conclusion}
\label{sec:org9dcf298}
\subsection{Contribution}
\label{sec:org00f4891}
\subsection{Future Research}
\label{sec:org703f436}
